...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 's1305001_www', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/jms_diextra/doctrine/EntityManager_51b5d72c82958.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_ff65d4a648c4e1d76289bb021491c6ac');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_ff65d4a648c4e1d76289bb021491c6ac');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_ff65d4a648c4e1d76289bb021491c6ac');
        ...
        $f->setProxyDir('/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager51b5d72c82958_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/sanofuzir/Sites/damainpotepuh/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'JMSAopBundle', 9 => 'JMSDiExtraBundle', 10 => 'JMSSecurityExtraBundle', 11 => 'damainpotepuhStaticBundle', 12 => 'damainpotepuhCoreBundle', 13 => 'damainpotepuhAdminBundle', 14 => 'FOSUserBundle', 15 => 'damainpotepuhUserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/sanofuzir/Sites/damainpotepuh/app/../web', false);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod',
            ...
            'session.save_path' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/profiler',
            ...
            'router.resource' => '/Users/sanofuzir/Sites/damainpotepuh/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/jms_diextra/doctrine/EntityManager_51b5d72c82958.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager51b5d72c82958_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Users/sanofuzir/Sites/damainpotepuh/app/cache/prod/jms_security',
