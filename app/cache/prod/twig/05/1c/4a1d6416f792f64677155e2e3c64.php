...
<form class=\"ad_form\" action=\"";
        // line 7
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["ad"]) ? $context["ad"] : null), "id")) ? ($this->env->getExtension('routing')->getPath("_admin_edit_ad", array("id" => $this->getAttribute((isset($context["ad"]) ? $context["ad"] : null), "id")))) : ($this->env->getExtension('routing')->getPath("_admin_add_ad"))), "html", null, true);
        echo "\" method=\"post\" ";
