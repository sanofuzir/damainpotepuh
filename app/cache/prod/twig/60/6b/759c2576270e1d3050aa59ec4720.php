...
<form class=\"ad_form\" action=\"";
        // line 7
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["subcategory"]) ? $context["subcategory"] : null), "id")) ? ($this->env->getExtension('routing')->getPath("_admin_edit_subcategory", array("id" => $this->getAttribute((isset($context["subcategory"]) ? $context["subcategory"] : null), "id")))) : ($this->env->getExtension('routing')->getPath("_admin_add_subcategory"))), "html", null, true);
        echo "\" method=\"post\" ";
